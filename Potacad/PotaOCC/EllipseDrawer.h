...
namespace PotaOCC
{
    ...
    public:
        ...
        static TopoDS_Edge DrawEllipse(Handle(V3d_View) view, IntPtr viewerHandlePtr, double dragStartX, double dragStartY, double dragEndX, double dragEndY, int h, int w);
    };
}